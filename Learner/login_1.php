...
<head>
    <meta charset="utf-8">
    <title>E-Learning Web App - Login</title>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            <h1 class="h2">Welcome back, Chief!</h1>
                            <p class="lead">
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        <img src="img/avatars/default-avatar.png" alt="Linda Miller" class="img-fluid rounded-circle" width="132" height="132" />
                                    </div>
                                    <form>
